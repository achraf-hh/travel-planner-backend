...
from numpy.testing import assert_array_equal, assert_equal, assert_raises, assert_raises_regex
...
class TestUnique:
    ...
    def test_unique_1d(self):
        ...
        dt = [('', 'i'), ('', 'i')]
        aa = np.array(list(zip(a, a, strict=False)), dt)
        bb = np.array(list(zip(b, b, strict=False)), dt)
        check_all(aa, bb, i1, i2, c, dt)
    ...
    def test_unique_array_api_functions(self):
        ...
        for res_unique_array_api, res_unique in [
            ...
            for actual, expected in zip(res_unique_array_api, res_unique, strict=False):
