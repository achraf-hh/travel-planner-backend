...
class TestLoadTxt(LoadTxtBase):
    ...
    def test_usecols(self):
        ...
        names = ['stid', 'temp']
        dtypes = ['S4', 'f8']
        arr = np.loadtxt(c, usecols=(0, 2), dtype=list(zip(names, dtypes, strict=False)))
...
M   33  21.99
    ...
    def test_usecols_with_structured_dtype(self):
        ...
        dtypes = ['S4', 'f8']
        test = np.genfromtxt(
            data, usecols=(0, 2), dtype=list(zip(names, dtypes, strict=False)))
    ...
    def test_unpack_auto_dtype(self):
        ...
        for arr, result in zip(expected, test, strict=False):
