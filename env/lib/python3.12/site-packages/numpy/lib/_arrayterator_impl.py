...
class Arrayterator:
    ...
    def __getitem__(self, index):
        ...
        for i, (start, stop, step, slice_) in enumerate(
                zip(self.start, self.stop, self.step, index, strict=False)):
    ...
    def __array__(self, dtype=None, copy=None):
        ...
        slice_ = tuple(slice(*t) for t in zip(
                self.start, self.stop, self.step, strict=False))
    ...
    def shape(self):
        ...
        return tuple(((stop-start-1)//step+1) for start, stop, step in
                zip(self.start, self.stop, self.step, strict=False))
    ...
    def __iter__(self):
        ...
        while True:
            ...
            # yield a block
            slice_ = tuple(slice(*t) for t in zip(start, stop, step, strict=False))
