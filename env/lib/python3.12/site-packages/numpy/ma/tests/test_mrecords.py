...
class TestMRecords:
    ...
    mask = [0, 1, 0, 0, 1]
    base = ma.array(list(zip(ilist, flist, slist, strict=False)), mask=mask, dtype=ddtype)
...
class TestView:
    ...
    def setup_method(self):
        ...
        arr = np.array(list(zip(a, b, strict=False)), dtype=ndtype)
    ...
    def test_view_simple_dtype(self):
        ...
        assert_equal(test, np.array(list(zip(a, b, strict=False)), dtype=float))
...
class TestMRecordsImport:
    ...
    def test_fromarrays(self):
        ...
        for (f, l) in zip(('a', 'b', 'c'), (_a, _b, _c), strict=False):
    ...
    def test_fromrecords(self):
        ...
        for (f, n) in zip(('c1', 'c2', 'c3'), ('a', 'b', 'c'), strict=False):
