    ...
    if depth < max_depth:
        shapes, slices, arrays = zip(
            *[_block_info_recursion(arr, max_depth, result_ndim, depth+1)
              for arr in arrays], strict=False)
        ...
        slices = [slice_prefix + the_slice
                  for slice_prefix, inner_slices in zip(slice_prefixes, slices, strict=False)
...
def _block_slicing(arrays, list_ndim, result_ndim):
    ...
    for the_slice, arr in zip(slices, arrays, strict=False):
