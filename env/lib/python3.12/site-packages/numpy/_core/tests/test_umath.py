...
class TestComparisons:
    ...
    def test_comparison_functions(self, dtype, py_comp, np_comp):
        ...
        comp_b_list = [int(py_comp(x, y)) for x, y in zip(a_lst, b_lst, strict=False)]
...
class TestDivision:
    ...
    def test_division_int_boundary(self, dtype, ex_val):
        ...
        with np.errstate(divide='ignore'):
            ...
            ac //= b
            div_ab = a // b
        div_lst = [c_div(x, y) for x, y in zip(a_lst, b_lst, strict=False)]
...
class TestFloat_power:
    def test_type_conversion(self):
        ...
        for dtin, dtout in zip(arg_type, res_type, strict=False):
...
class TestLogAddExp2(_FilterInvalids):
    ...
    def test_logaddexp2_values(self):
        ...
        y = [5, 4, 3, 2, 1]
        z = [6, 6, 6, 6, 6]
        for dt, dec_ in zip(['f', 'd', 'g'], [6, 15, 15], strict=False):
...
class TestBitwiseUFuncs:
    ...
    @pytest.mark.parametrize("input_dtype_obj, bitsize",
            zip(bitwise_types, bitwise_bits, strict=False))
...
def test_spacing_gfortran():
    ...
    for dt, dec_ in zip([np.float32, np.float64], (10, 20), strict=False):
